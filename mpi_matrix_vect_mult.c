...
//     // double A[n_local][n], b[n];
//     // double c[n_local], cglobal[n];
//     // int i, j;
...
//     // MPI_Allgather(c, n_local, MPI_DOUBLE, cglobal, n_local, 
//     //                         MPI_DOUBLE, MPI_COMM_WORLD);


//     // mat_vect_mult( a, x, y, 3, 3, 9, MPI_COMM_WORLD);
...
// void mat_vect_mult( DD local_A[], DD local_x[], DD local_y[],
//                     II local_m, II n, II local_n, MPI_Comm comm ) {
//     DD* x;
//     II local_i, j;
//     II local_ok = 1;
